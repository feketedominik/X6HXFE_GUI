...
using X6HXFE_HFT_2021222.Repository;
using X6HXFE_HFT_2021222.Repository.Interfaces;
using X6HXFE_HFT_2021222.Repository.ModelRepositories;

namespace X6HXFE_HFT_2021222.Endpoint
{
    ...
    {     
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "X6HXFE_HFT_2021222.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "X6HXFE_HFT_2021222.Endpoint v1"));
            }
